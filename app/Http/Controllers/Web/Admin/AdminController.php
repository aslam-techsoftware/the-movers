...
class AdminController extends BaseController
{
    ...
    */
    public function create()
    {
        ...
        return view('admin.admin.create', compact('admins', 'page', 'countries', 'main_menu', 'sub_menu', 'roles', 'services','zones'));
    }
    ...
    public function store(CreateAdminRequest $request)
    {
        ...
        $created_params = $request->only(['service_location_id','zone_id', 'first_name','mobile','email','address','state','city','country']);
        //dd($created_params);
    ...
    public function update(AdminDetail $admin, UpdateAdminRequest $request)
    {
        ...
        $updatedParams = $request->only(['service_location_id','zone_id', 'first_name','mobile','email','address','state','city','country']);
