...
class AdminDetail extends Model
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'address', 'country','state','city','pincode','email','mobile','user_id','created_by','service_location_id','zone_id'
    ];
    ...
    */
    ...
    {
        if (!$this->zoneDetail()->exists()) {
            return null;
        }
        return $this->zoneDetail->name;
    }
    /**
    * Get profile picture
    *
